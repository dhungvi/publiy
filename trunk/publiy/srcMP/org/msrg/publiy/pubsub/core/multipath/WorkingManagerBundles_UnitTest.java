...
public class WorkingManagerBundles_UnitTest extends TestCase {
	...
	protected final InetSocketAddress _localAddress = new InetSocketAddress("127.0.0.1", 2005);
	protected final String _topString =
		"S/127.0.0.1:2005 B/127.0.0.1:2002" + "\n" +
		"B/127.0.0.1:2002 B/127.0.0.1:2014" + "\n" +
		"B/127.0.0.1:2002 B/127.0.0.1:2011" + "\n" +
		"B/127.0.0.1:2011 B/127.0.0.1:2020" + "\n" +
		"B/127.0.0.1:2020 B/127.0.0.1:2008" + "\n" +
		"B/127.0.0.1:2020 B/127.0.0.1:2017" + "\n" +
		"B/127.0.0.1:2011 B/127.0.0.1:2010" + "\n" +
		"B/127.0.0.1:2010 P/127.0.0.1:2001" + "\n" +
		"B/127.0.0.1:2010 S/127.0.0.1:2019" + "\n" +
		"B/127.0.0.1:2010 P/127.0.0.1:2009";
	protected String _subString =
		"127.0.0.1:2009 word    =       1 ,     count   %       5," + "\n" +
		"127.0.0.1:2001 word    =       1 ,     count   %       5," + "\n" +
		"127.0.0.1:2019 word    =       1 ,     count   %       5,";
	protected TRecovery_Subscription[] _trs;
	
	protected String _pubStr = "word	1	count	5";
	protected WorkingRemoteSet _initialMatchingSet;
	protected WorkingRemoteSet _strategizedMatchingSet;
	
	protected int _delta = 3;
	protected String _actSessionsStr = "127.0.0.1:2002";
	protected String _softSessionsStr = "127.0.0.1:2019,127.0.0.1:2010," +
		"127.0.0.1:2002,127.0.0.1:2011";
	protected String _candSessionsStr = "127.0.0.1:2001,127.0.0.1:2009";
	...
	public void setUp() {
		...
		IBrokerShadow brokerShadow = new BrokerShadow(NodeTypes.NODE_BROKER, _localAddress).setDelta(_delta).setMP(true);
		_workingManagerBundle =
			createWorkingManagerBundles(brokerShadow, _actSessionsStr, _softSessionsStr, _candSessionsStr,
					_topString, _subString);
		_masterOverlayManager = _workingManagerBundle.getMasterOverlayManager();
		_masterSubscriptionManager = _workingManagerBundle.getMasterSubscriptionManager();
		Publication pub = Publication.decode(_pubStr);
		_initialMatchingSet = _workingManagerBundle._workingSubscriptionManager.getMatchingWokringSet(pub);
	}
	...
	public void testWorkingBundles() {
		_strategizedMatchingSet =
			_workingManagerBundle._workingOverlayManager.computeSoftLinksAddresses(null, PubForwardingStrategy.PUB_FORWARDING_STRATEGY_2, _initialMatchingSet);
		System.out.println(_strategizedMatchingSet);
		assert(true);
	}
	...
	public static WorkingManagersBundle createWorkingManagerBundles(
		...
		IOverlayManager masterOverlayManager = new OverlayManager(brokerShadow);
